...
export default async function Home() {
  ...
  return (
    ...
    <div>
      <div className="div-block-6"><img src="images/Diputad-1.gif" loading="lazy" alt="" className="image-31"/>
        <form action="/search" className="search-2 w-form"><input className="search-input-2 w-input" maxLength={256} name="query" placeholder="Busca a tu diputado" type="search" id="search-2" /><input type="submit" className="search-button-2 w-button" value="Buscar"/></form>
      </div>
          ...
          <div className="column-3 w-col w-col-6">
            <div className="columns-3 w-row">
              <div className="column-2 w-col w-col-6">
                <a href="perfil-diputado.html" className="w-inline-block">
                  <img src="images/2PAN-Emma-Laura-Álvarez-Villavicencio-01.png" loading="lazy" alt="" className="image-3"/></a>
              </div>
            ...
            <div className="columns-4 w-row">
              <div className="w-col w-col-6">
                <div className="div-block-16">
                  <p className="paragraph-3">Contacto</p><img src="images/mail_icon.png" loading="lazy" alt="" className="image-4"/>
                </div>
              </div>
              <div className="column-5 w-col w-col-6">
                ...
                <div className="social-media">
                  <img src="images/facebook_icon.png" loading="lazy" alt="" className="image-5" /><img src="images/x_icon.png" loading="lazy" alt="" className="image-6" /><img src="images/instagram_icon.png" loading="lazy" alt="" className="image-7" /><img src="images/tiktok_icono.png" loading="lazy" sizes="(max-width: 479px) 100vw, (max-width: 763px) 97vw, (max-width: 767px) 741px, 24vw" srcSet="images/tiktok_icono-p-500.png 500w, images/tiktok_icono.png 741w" alt="" className="image-8" /></div>
              </div>
            </div>
          </div>
          <div className="w-col w-col-6">
